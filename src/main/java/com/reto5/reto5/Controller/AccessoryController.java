...
import com.reto5.reto5.Service.AccessoryService;
...
public class AccessoryController {
    ...
    public List<Footwears> getFindByPrice(@PathVariable("price") double price)
    {
        return accessoryService.getFindByPrice(price);
    }
    
    @GetMapping("/description/{description}")
    public List<Footwears>getByDescription(@PathVariable("description") String description)
    {
        return accessoryService.getFindByDescription(description);
    }
}
