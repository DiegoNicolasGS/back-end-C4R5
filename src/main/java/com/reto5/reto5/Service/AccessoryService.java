...
import com.reto5.reto5.Repository.AccessoryRepository;
...
public class AccessoryService {
    ...
    {
        return accesoryRepository.getfindByPrice(price);
    }
    
    public List<Footwears>getFindByDescription(String description)
    {
        return accesoryRepository.getFindByDescription(description);
    }
}
